...
The objective is to create a population–based stochastic optimization method that is based on the concept of the optimization method Harmony Search. New operators are applied for the improvement of the classical Harmony Search method, based on the theory of dance composition, and as a result, the method is named Choreography Composition-LikeOptimization (CCLO). 
...
> A finance problem, where the economic order quantity of a product in a company is calculated. The company uses the shortage model and the supplier applies tiered pricing to the product.
